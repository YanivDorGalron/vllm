...
class NemotronHConfig(PretrainedConfig):
    ...
    Args:
        ...
        mtp_bottleneck_hidden_size (`int` or `None`, *optional*, defaults to `None`):
            Hidden size used inside the MTP predictor.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.mtp_bottleneck_hidden_size is not None:
